 ...
 * to the additional requested_size field.
 *
...
#include "mctx_internal.h"
  ...
  */
#define MEMORYCHUNK_MAX_VALUE			UINT64_C(0x3FFFFFFF)
 ...
 */
#define MEMORYCHUNK_MAX_BLOCKOFFSET		UINT64_C(0x3FFFFFFF)

/*
 * As above, but mask out the lowest-order (always zero) bit as this is shared
 * with the MemoryChunkGetValue field.
 */
#define MEMORYCHUNK_BLOCKOFFSET_MASK 	UINT64_C(0x3FFFFFFE)
 ...
 * external bit.
 */
#define MEMORYCHUNK_MAGIC		(UINT64_C(0xB1A8DB858EB6EFBA) >> \
